...
const SECTIONS = [
  ...
  { key: SECTION_KEYS.MAILBOX_CONFIG, label: "shared mailboxes", iconClass: "icon-group" },
  { key: SECTION_KEYS.SIGNATURE_TEMPLATE, label: "signature template", iconClass: "icon-customize" },
  { key: SECTION_KEYS.APP_ORDER, label: "nextcloud app order", iconClass: "icon-settings-dark" },
] as const;
